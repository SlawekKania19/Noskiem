...
@section('title', 'Nowe zgłoszenie czeka na moderację')

@section('content')
    <h1 style="margin:0 0 16px; font-size:20px; color:#283618;">Nowe zgłoszenie czeka na moderację</h1>

    <p style="margin:0 0 16px; font-size:14px; line-height:1.6; color:#616657;">
        Zgłoszenie #{{ $animalEdit->id }}
        ({{ $animalEdit->status === 'lost' ? 'zaginiony' : 'znaleziony' }} — {{ $animalEdit->title }})
