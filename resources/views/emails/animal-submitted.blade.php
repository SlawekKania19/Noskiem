...
@section('content')
    ...
    <p style="margin:0 0 16px; font-size:14px; line-height:1.6; color:#616657;">
        Otrzymaliśmy Twoje zgłoszenie i trafiło do moderacji. Gdy tylko je zatwierdzimy, ogłoszenie pojawi się
        na stronie — wyślemy Ci wtedy kolejnego maila z linkiem do jego edycji.
    </p>
