...
// ---------------------------
// Polskie komunikaty walidacji. Bez tego pliku Laravel używa wbudowanych
// angielskich (APP_LOCALE=pl, ale brak lang/pl/*). Standardowe tłumaczenie
// (za projektem Laravel-Lang), dostosowane do potrzeb projektu.
// ---------------------------
...
return [
    ...
    'ascii' => 'Pole :attribute może zawierać wyłącznie jednobajtowe znaki i symbole alfanumeryczne.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Podane hasło wyciekło w internecie. Wybierz inne hasło.',
    ],
    ...
    // ** Własne komunikaty dla konkretnych pól — [pole => [reguła => komunikat]]
    'custom' => [
        'attribute-name' => [
    ...
    // ** Czytelne nazwy pól podstawiane pod :attribute
    'attributes' => [
